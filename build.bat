...
AjaxMin.exe -inline:no -clobber -term lang\vi_wordlist.js lang\vi_defs.js lang\vi_letters.js src\redipsdrag.js src\bonuses.js src\ui.js src\engine.js src\events.js -out %target%\js\app.min.js
